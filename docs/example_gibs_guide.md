## GIBS Telescope Integration Guide for MACROSLOW MCP SDKs

This guide details how to integrate NASA's Global Imagery Browse Services (GIBS) into a MCP SDK for real-time Earth imagery visualization.
